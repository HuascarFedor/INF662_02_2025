          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                if(isEditing){
                  provider.updateMemo(memo.id, title, content);
                }
                else{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: memos.isEmpty 
        ? const Center(
          child: Text(
            'No hay memos aún. \nToca el botón + para agregar un nuevo memo.',
        ...
        : ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              title: Text(memo.title.isEmpty ? '(Sin titulo)' : memo.title),
              subtitle: Text(
                memo.content,
                maxLines: 2,
                overflow: TextOverflow.ellipsis,
              ),
              onTap: () => _openMemoForm(context, memo: memo),
              trailing: IconButton(
                onPressed: () => memoProvider.deleteMemo(memo.id), 
